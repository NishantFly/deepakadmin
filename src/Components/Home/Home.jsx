...
const Home = (props) => {
  ...
  const home = [
    ...
    { show: "User", link: "user"},
    { show: "User Login", link: "user/login"},
    { show: "Add User", link: "otp/send"},
    { show: "Documents", link: "admin/documents"},
    { show: "Vehicle", link: "/get/vehicle"},
    { show:  "Station", link: "/get/station"},
    { show:  "Service", link: "/get/service"},
